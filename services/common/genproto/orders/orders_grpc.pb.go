...
type OrderServiceClient interface {
	...
	GetOrders(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*GetOrdersResponse, error)
}
...
func (c *orderServiceClient) GetOrders(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*GetOrdersResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type OrderServiceServer interface {
	...
	GetOrders(context.Context, *GetOrderRequest) (*GetOrdersResponse, error)
...
func (UnimplementedOrderServiceServer) GetOrders(context.Context, *GetOrderRequest) (*GetOrdersResponse, error) {
